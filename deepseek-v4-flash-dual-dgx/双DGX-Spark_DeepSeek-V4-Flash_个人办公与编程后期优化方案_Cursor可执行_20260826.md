...
| 项目 | 当前状态 |
|---|---|
| Node 0 | `172.19.50.70`，Rank 0 / API |
...
```jsonc
{
  ...
  "providers": {
    "local-dgx": {
      ...
      "settings": {
        "baseURL": "http://172.19.50.70:8000/v1"
      },
...
NIM API = http://172.19.50.70:8000/v1
...
15. baseURL 指向 http://172.19.50.70:8000/v1。
